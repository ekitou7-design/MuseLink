...
| 内容 | 当前状态 |
|------|------|
| 导入文物 | `data/imported-artifacts.json` 中 92 件 |
| AI-ready 文物 | 已生成 v1 和 v2，推荐看 `data/imported-artifacts.ai-ready.v2.json` |
| RAG 文档 | `data/rag/artifacts-rag-documents.v2.jsonl` 中 92 条，可导入 Dify、FastGPT、RAGFlow 等平台 |
| 关系候选 | `data/artifact-relation-seeds.v2.json` 中 229 条，用于后续知识图谱审核 |
| 博物馆聚合 | `data/imported-museums.json` 中 83 个博物馆条目 |
