...
- `HomePage.tsx`：浏览、搜索、筛选 92 件导入文物，并进入文物详情
- `ProfilePage.tsx`：查看自己收藏的文物和生成的展陈
- `AdminPage.tsx`：查看用户和系统统计，后续可扩展为知识库审核入口

智能策展和相关文物推荐会使用知识库检索候选。当前候选来自后端本地关键词排序，还没有接入外部向量数据库。
