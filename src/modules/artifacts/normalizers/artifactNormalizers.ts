...
export const normalizeArtifact = (raw: unknown): Artifact => {
  ...
  return {
    ...
    isEditorRecommended: Boolean(source.isEditorRecommended ?? source.is_editor_recommended),
    is_editor_recommended: Boolean(source.isEditorRecommended ?? source.is_editor_recommended),
    editorRecommendationOrder: Number(source.editorRecommendationOrder ?? source.editor_recommendation_order ?? 0),
    editor_recommendation_order: Number(source.editorRecommendationOrder ?? source.editor_recommendation_order ?? 0),
    tags,
