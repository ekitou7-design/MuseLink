...
export const normalizeExhibition = (raw: unknown): Exhibition | null => {
  ...
  return {
    ...
    aiGenerated: source.aiGenerated ?? source.ai_generated,
    generationNotice: source.generationNotice ?? source.generation_notice,
    generationError: source.generationError ?? source.generation_error,
