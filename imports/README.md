...
`imports` 是知识库的入口准备区。这里放导入任务和示例数据，导入成功后才会写入 `data/imported-artifacts.json`，再由数据准备脚本生成 AI-ready、RAG JSONL 和知识图谱关系候选。

当前仓库已经导入了 92 件文物，并生成了可用于技术验证的 AI-ready v2 数据、92 条 RAG 文档和 229 条关系候选。
